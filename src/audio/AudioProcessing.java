...
public class AudioProcessing {
	...
	public void playlistStart() {
		...
		this.playListIndex++;											//TODO: put these 4 lines in a loop that calls fileStart in a synchronized way
		tempAudioFile.setPath((this.getPlayList().get(playListIndex)));	//		(so that it waits for the thread generated by fileStart to finish, in order
		this.setFileToStart(tempAudioFile);								//		to move to the next file in the playlist)
		this.fileStart(fileToStart);									//		or try using a loop on PlaybackController.
	}
